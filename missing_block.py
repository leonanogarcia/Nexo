    ...
    def cadastro(self, f):
        ...
        self.mat_tree=ttk.Treeview(table_host,columns=('code','name','brand','qty','unit','value','category','date','edit','delete'),show='tree')
    ...
    def _bulk_delete_list(self, tree, kind):
        ...
        self.refresh_all();self.notify(f'{len(rows)} itens excluídos com sucesso.')
