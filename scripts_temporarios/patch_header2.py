...
methods = [n for n in ast.walk(extractor) if isinstance(n, ast.FunctionDef) and n.name == 'redraw_mat_header']
m_redraw = methods[0]

lines = text.split('\n')
lines_before = lines[:m_redraw.lineno-1]
lines_after = lines[m_redraw.end_lineno:]
